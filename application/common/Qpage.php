...
class Qpage {
    ...
    public static function page($pages, $page, $url) {
        if ($pages != 1) {
            ...
            $tmp = ['start' => '<ul class="pager pager-pills">
                                <li class="first ' . $isstart . '"><a class="pager-item icon icon-step-backward" data-page="1" href="' . $url . '1"></a></li>
                                <li class="previous ' . $isstart . '"><a class="pager-item" data-page="' . $prew . '" href="' . $url . $prew . '">«</a></li>', 'end' => '<li class="next ' . $isend . '"><a class="pager-item" data-page="' . $next . '" href="' . $url . $next . '">»</a></li>
