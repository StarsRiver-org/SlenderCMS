...
class Usenroll extends Controller {
    ...
    public function main() {
        ...
        if (!empty($dbres)) {
            return Qhelp::json_en(['Stat' => 'OK', "Message" => '报名成功,请耐心等待短信通知', 'Data' => ['sex' => $_POST['sex'] == 1 ? '男' : '女', 'name' => Qhelp::receive('name', ''), 'phone' => $_POST['phone'], 'photo' => "<img src='" . SITE . "/data/catch/temp/avatar/" . $avtName . "'>", 'aim' => $_POST['aim'], 'aim2' => Qhelp::receive('aim2', '')]]);
        } else {
