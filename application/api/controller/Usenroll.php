<?php
    ...
    class Usenroll extends Controller {
        ...
        public function main() {
            ...
            if (empty($_POST['studentid']) || strlen($_POST['studentid']) != 10 ||  !Qhelp::chk_pint($_POST['studentid']) || $_POST['studentid'] < 2018000000) {
                return Qhelp::json_en(['Stat' => 'error', "Message" => '请填2018年的学号谢谢']);
            }
